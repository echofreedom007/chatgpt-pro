...
function App() {
  ...
  async function handleSubmit(e) {
    ...
    // fetch response to the api combining the input and the chatlog array of messages and sending it as a message to localhost:30000 as a post
  ...
  return (
    <div className={`chat-message ${message.user === "gpt" && "chatgpt"}`}>
      <div className="chat-message-center">
        <div className={`kitty ${message.user === "gpt" && "chatgpt"}`}>
